...
router.get('/manage', check_auth, function (req, res) {
...
router.get('/admin', check_auth, function (req, res) {
...
router.get('/create', check_auth, function (req, res) {
  res.render('create', {title: '설문 제작'});
});

router.post('/save', check_auth, function (req, res) {
...
router.get('/stat/:a', check_auth, function (req, res) {
  //res.render('index', { title: 'Express' });
...
router.get('/survey/:url', function (req, res) {
  //res.render('index', { title: 'Express' });
  // noinspection JSDeprecatedSymbols
...
router.get('/del/:url', function (req, res) {
  //res.render('index', { title: 'Express' });
  SurveyData.deleteMany({url: req.params.url}, function (err) {
    assert.equal(null, err);
    Survey_ans.deleteMany({url: req.params.url}, function (err) {
      assert.equal(null, err);
...
router.get('/dbtest/:a', function (req, res) {
  //res.render('index', { title: 'Express' });
